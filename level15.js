window.addEventListener('load', function() {
    const audio15 = document.getElementById('myAudio');
    const modal15 = document.getElementById('modal151');
    const playButton15 = document.getElementById('question15');
...
document.querySelectorAll("button")[4].addEventListener("click",function(){
    ...
    var Sahi_Jawab = new Audio("Kbc - Right Answer Sound.mp3");
       ...
       Taliya.play();
       alert("Mubarak ho aap 75,00,000 ruppye ki Dhan Rashi Jeet Chuke hain ");
