...
window.addEventListener('load', function() {
    const audio4 = document.getElementById('myAudio');
    const modal4 = document.getElementById('modal41');
    const playButton4 = document.getElementById('question4');
...
document.querySelectorAll("button")[2].addEventListener("click",function(){
    if (chosenAnswer22==answer2){
       ...
       Taliya.play();
       alert("Mubarak ho aap 5,000 ruppye ki Dhan Rashi Jeet Chuke hain ");
    }
