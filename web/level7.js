window.addEventListener('load', function() {
    const audio7 = document.getElementById('myAudio');
    const modal7 = document.getElementById('modal71');
    const playButton7 = document.getElementById('question7');
...
document.querySelectorAll("button")[2].addEventListener("click",function(){
    if (chosenAnswer22==answer2){
       ...
       Taliya.play();
       alert("Mubarak ho aap 40,000 ruppye ki Dhan Rashi Jeet Chuke hain ");   
