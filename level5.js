window.addEventListener('load', function() {
    const audio5 = document.getElementById('myAudio');
    const modal5 = document.getElementById('modal51');
    const playButton5 = document.getElementById('question5');
...
document.querySelectorAll("button")[3].addEventListener("click",function(){
    if (chosenAnswer23==answer2){
       ...
       Taliya.play();
       alert("Mubarak ho aap 10,000 ruppye ki Dhan Rashi Jeet Chuke hain "); 
    }
    else{
        alert("apsoss ye galat uttar hai!!")
        var Galat_Jawab = new Audio("Kbc Galat Jawab.mp3");
