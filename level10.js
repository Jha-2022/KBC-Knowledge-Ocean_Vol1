window.addEventListener('load', function() {
    const audio10 = document.getElementById('myAudio');
    const modal10 = document.getElementById('modal101');
    const playButton10 = document.getElementById('question10');
...
document.querySelectorAll("button")[1].addEventListener("click",function(){
 if (chosenAnswer21==answer2){
    ...
    Taliya.play();
    alert("Mubarak ho aap 3,20,000 ruppye ki Dhan Rashi Jeet Chuke hain ");  
