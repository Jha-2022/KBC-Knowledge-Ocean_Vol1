...
window.addEventListener('load', function() {
    const audio3 = document.getElementById('myAudio');
    const modal3 = document.getElementById('modal31');
    const playButton3 = document.getElementById('question3');
...
document.querySelectorAll("button")[3].addEventListener("click",function(){
    if (chosenAnswer23==answer2){
       ...
       Taliya.play();
       alert("Mubarak ho aap 3,000 ruppye ki Dhan Rashi Jeet Chuke hain ");
    }
    else{
        alert("apsoss ye galat uttar hai!!")
        var Galat_Jawab = new Audio("Kbc Galat Jawab.mp3");
