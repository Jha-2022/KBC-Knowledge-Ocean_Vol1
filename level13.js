window.addEventListener('load', function() {
    const audio13 = document.getElementById('myAudio');
    const modal13 = document.getElementById('modal131');
    const playButton13 = document.getElementById('question13');
  
    playButton13.addEventListener('click', function() {
      audio13.play();
...
document.querySelectorAll("button")[1].addEventListener("click",function(){
 if (chosenAnswer21==answer2){
    ...
    Taliya.play();
    alert("Mubarak ho aap 25,00,000 ruppye ki Dhan Rashi Jeet Chuke hain ");
