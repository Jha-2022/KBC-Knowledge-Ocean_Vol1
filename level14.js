window.addEventListener('load', function() {
    const audio14 = document.getElementById('myAudio');
    const modal14 = document.getElementById('modal141');
    const playButton14 = document.getElementById('question14');
  
    playButton14.addEventListener('click', function() {
      audio14.play();
...
document.querySelectorAll("button")[3].addEventListener("click",function(){
    if (chosenAnswer23==answer2){
       ...
       Taliya.play();
       alert("Mubarak ho aap 50,00,000 ruppye ki Dhan Rashi Jeet Chuke hain ");
